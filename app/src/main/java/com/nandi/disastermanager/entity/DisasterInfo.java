...
public class DisasterInfo {
    ...
    public int getDis_sfss() {
        return dis_sfss;
    }

    public void setDis_sfss(int dis_sfss) {
        this.dis_sfss = dis_sfss;
    }

    public int getTs_sfyl() {
        return ts_sfyl;
    }

    public void setTs_sfyl(int ts_sfyl) {
        this.ts_sfyl = ts_sfyl;
    }
}
