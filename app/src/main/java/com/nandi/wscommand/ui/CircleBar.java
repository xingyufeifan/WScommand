package com.nandi.wscommand.ui;
...
public class CircleBar extends View {
    ...
    private int mTextColor = getResources().getColor(R.color.color_green_pie);//默认文字颜色
    private int mWheelColor = getResources().getColor(R.color.color_green_pie);//默认圆环颜色
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mTextDesSize = dip2px(getContext(), 20);
        ...
        mDefaultWheelPaint.setColor(getResources().getColor(R.color.color_red_pie));
        ...
        textPaint.setTextAlign(Paint.Align.LEFT.LEFT);
        textPaint.setTextSize(mTextSize);
        //描述文字的画笔
        textDesPaint = new Paint(Paint.ANTI_ALIAS_FLAG | Paint.LINEAR_TEXT_FLAG);
        textDesPaint.setColor(getResources().getColor(R.color.color_green_pie));
